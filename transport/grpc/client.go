...
import (
	...
	"github.com/devexps/go-micro/v2/selector/wrr"
	"github.com/devexps/go-micro/v2/transport"
	"github.com/devexps/go-micro/v2/transport/grpc/resolver/discovery"

	// init resolver
	_ "github.com/devexps/go-micro/v2/transport/grpc/resolver/direct"
)
