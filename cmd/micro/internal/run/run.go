...
// CmdRun run service command.
var CmdRun = &cobra.Command{
	Use:   "run",
	Short: "Run service",
	Long:  "Run service. Example: micro run",
	Run:   Run,
}
...
func Run(cmd *cobra.Command, args []string) {
	...
	if len(programArgs) == 0 {
		programArgs = append(programArgs, "-conf")
		programArgs = append(programArgs, filepath.Join(dir, "../../configs"))
	}
