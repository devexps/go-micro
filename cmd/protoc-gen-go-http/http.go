...
const (
	...
	transportHTTPPackage = protogen.GoImportPath("github.com/devexps/go-micro/v2/transport/http")
	bindingPackage       = protogen.GoImportPath("github.com/devexps/go-micro/v2/transport/http/binding")
)

var methodSets = make(map[string]int)

// generateFile generates a _http.pb.go file containing micro errors definitions.
...
// generateFileContent generates the micro errors definitions, excluding the package statement.
func generateFileContent(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, omitempty bool, omitemptyPrefix string) {
	...
	g.P("// is compatible with the micro package it is being compiled against.")
